...
tapestri barcode extract --input-fwd $in_first --input-rev $in_second --output-fwd $out_first --output-rev $out_second --output-barcodes $barcode_output --output-metrics $barcode_metrics --chemistry protein.V2 --cut-adapters --decode --cores $cores --barcode-suffix -1
