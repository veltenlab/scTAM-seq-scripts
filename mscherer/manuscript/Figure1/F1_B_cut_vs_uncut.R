...
ggsave(file.path(plot.path, 'F1_B_cut_vs_uncut_all.pdf'), plot, width=200, height=150, units='mm')
...
ggsave(file.path(plot.path, 'F1_B_cut_vs_uncut_selected.pdf'), plot, width=200, height=150, units='mm')