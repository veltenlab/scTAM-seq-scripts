...
clust.file <- clust.file[row.names(doublet.file[which(doublet.file$DoubletDetectionLabel==0),]),]
...
ggsave(file.path(out.folder,"Supplement_UMAP.pdf"), width = 125, height = 100, unit='mm')
plot <- DimPlot(seurat.obj, reduction = "pca",group.by = 'CellType',
                cols = c('Jurkat'='#ff9289', 'K562'='#82b7ff','Mixed'='gray'))+plot_theme
ggsave(file.path(out.folder,"Supplement_PCA.pdf"), width = 125, height = 100, unit='mm')
...
plot <- DimPlot(seurat.obj, reduction = "umap",group.by = 'CellType',
                cols = c('Jurkat'='#ff9289', 'K562'='#82b7ff','Mixed'='gray'))+plot_theme
ggsave(file.path(out.folder,"Supplement_UMAP_untreated.pdf"), width = 125, height = 100, unit='mm')
plot <- DimPlot(seurat.obj, reduction = "pca",group.by = 'CellType',
                cols = c('Jurkat'='#ff9289', 'K562'='#82b7ff','Mixed'='gray'))+plot_theme
ggsave(file.path(out.folder,"Supplement_PCA_untreated.pdf"), width = 125, height = 100, unit='mm')
