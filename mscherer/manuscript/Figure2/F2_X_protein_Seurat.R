...
prot_data_all <- read.table(paste0('/users/mscherer/cluster/project/Methylome/analysis/missionbio/tapestri/protein/', 
...
seurat.obj <- CreateSeuratObject(t(prot_data),
                                ...
                                meta.data = rowinfo[, c("CellType_broad", "CellType")])
...
plot <- DimPlot(seurat.obj, reduction = "umap", group.by = 'CellType')+scale_color_manual(values=color_map$CellType)
ggsave('/users/mscherer/cluster/project/Methylome/analysis/scTAMseq_manuscript/Figure2/Sample8/protein/UMAP.png', plot)

FeaturePlot(seurat.obj, reduction = "umap", feature = 'CD27')
