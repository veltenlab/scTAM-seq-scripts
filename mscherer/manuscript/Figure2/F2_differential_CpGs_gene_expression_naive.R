...
sel.cpgs <- read.csv('/users/mscherer/cluster/project/Methylome/analysis/scTAMseq_manuscript/Figure2/differential_naive/differential_CpGs_ Cluster1avsCluster1b .csv')
