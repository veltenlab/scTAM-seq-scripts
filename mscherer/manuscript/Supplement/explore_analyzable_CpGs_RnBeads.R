...
rnb.set <- load.rnb.set('/users/mscherer/cluster/project/Methylome/misc/DEEP/TCells/import_RnBSet/')
...
ggsave('/users/lvelten/project/Methylome/analysis/scTAMseq_manuscript/Supplement/analyzable_CpGs.pdf',
       height=100,
       width=100,
       unit='mm')
