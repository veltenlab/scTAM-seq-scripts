...
sel.amplis <- ampli.info$AmpID_design_1898[grepl('Aci',ampli.info$Type)&!ampli.info$Hha1]
# AMPL134313 has substantially less reads in comparison to the other amplicons
sel.amplis <- sel.amplis[-which(sel.amplis%in%c('AMPL131129','AMPL134270','AMPL134313'))]
