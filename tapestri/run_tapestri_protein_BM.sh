...
/users/lvelten/project/Methylome/src/scTAM-seq-scripts/mscherer/tapestri/tapestri_pipeline_protein_BCells.sh -p /users/lvelten/project/Methylome/data/BM/Sample12/protein/ -s Sample12 -n Sample12 -o /users/lvelten/project/Methylome/analysis/missionbio/tapestri/protein/Sample12/ -c 4
